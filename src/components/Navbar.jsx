          ...
          <div className="flex justify-between items-center">
            <div className="flex items-center space-x-4">
              <Link href="/" className="flex items-center">
                <div className="bg-gray-800 text-white p-2 rounded">NL</div>
            ...
            <div className="relative flex-grow max-w-lg mx-4">
              <input 
                ...
                className="w-full border border-gray-300 rounded-full py-2 px-4 focus:outline-none focus:ring-2 focus:ring-gray-300" 
              />
